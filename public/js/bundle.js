...
const List = __webpack_require__(27);

let props = window.props;

ReactDOM.render(React.createElement(List, { messages: window.__data }), document.getElementById('content'));
...
const UserView = __webpack_require__(28);
...
class List extends React.Component {
    ...
    componentDidMount() {
        fetch('/messages').then(response => response.json()).then(json => this.setState({ data: json })).catch(error => console.error(error));
    }
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('input', { id: 'nameInput', type: 'text', onChange: this.handleNameChange, value: this.state.name }),
                ...
                React.createElement('input', { id: 'messageInput', type: 'text', onChange: this.handleMsgChange, value: this.state.msg }),
                React.createElement(
                    'button',
                    { className: 'btn btn-info', onClick: this.handleFetch },
                    'Send Message'
                )
            ),
            React.createElement(
                'table',
                { style: tableStyles, className: 'table' },
                React.createElement(
                    'thead',
                    null,
                    React.createElement(
                ...
                React.createElement(
                    'tbody',
                    null,
                    this.state.data.map((name, index) => React.createElement(UserView, { key: index, data: name }))
                )
            )
        );
    }
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    'button',
                    { onClick: this.deleteItem, className: 'button btn-cta tertiary tiny valign-middle', style: butStyles },
                    'Delete Me!'
                )
            )
        );
